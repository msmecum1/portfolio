...
<section class="container mx-auto max-w-6xl px-4 py-8">
	<h1
		class="mb-6 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-center text-4xl font-bold text-transparent"
	>
		Hire Me
	</h1>
	<p class="mb-6 text-center text-lg text-gray-600">
		Select how you'd like to work with me on your next project:
	</p>
	...
	<form method="POST" class="space-y-6">
		...
		{#if selectedOption === 'full-time'}
			<div class="mt-6 space-y-4">
				<div>
					<label for="ftJobDescription" class="block text-sm font-medium text-gray-700"
					...
					<textarea
						...
						class="mt-1 block w-full rounded-lg border-gray-300 bg-white p-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
						rows="4"
						placeholder="Describe the job role and responsibilities"
					></textarea>
				</div>
				<div>
					<label for="ftStartDate" class="block text-sm font-medium text-gray-700"
						>Requested Start Date</label
					>
					<input
						id="ftStartDate"
						name="ftStartDate"
				...
				<div>
					<label for="ftPayRange" class="block text-sm font-medium text-gray-700"
						>Pay Range (Annual)</label
					>
					<input
						id="ftPayRange"
						name="ftPayRange"
				...
				<div>
					<label for="ftPocName" class="block text-sm font-medium text-gray-700"
						>Point of Contact Name</label
					>
					<input
						id="ftPocName"
						name="ftPocName"
				...
				<div>
					<label for="ftCompany" class="block text-sm font-medium text-gray-700"
						>Affiliated Company</label
					>
					<input
						id="ftCompany"
						name="ftCompany"
				...
				<div>
					<label for="ftPhoneNumber" class="block text-sm font-medium text-gray-700"
						>Phone Number</label
					>
					<input
						id="ftPhoneNumber"
		...
		{#if selectedOption === 'part-time'}
			<div class="mt-6 space-y-4">
				<div>
					<label for="ptJobDescription" class="block text-sm font-medium text-gray-700"
						>Job Description</label
					>
					<textarea
						id="ptJobDescription"
				...
				<div>
					<label for="ptStartDate" class="block text-sm font-medium text-gray-700"
						>Requested Start Date</label
					>
					<input
						id="ptStartDate"
				...
				<div>
					<label for="ptHourlyRate" class="block text-sm font-medium text-gray-700"
						>Hourly Rate Range</label
					>
					<input
						id="ptHourlyRate"
						name="ptHourlyRate"
				...
				<div>
					<label for="ptPocName" class="block text-sm font-medium text-gray-700"
						>Point of Contact Name</label
					>
					<input
						id="ptPocName"
				...
				<div>
					<label for="ptCompany" class="block text-sm font-medium text-gray-700"
						>Affiliated Company</label
					>
					<input
						id="ptCompany"
				...
				<div>
					<label for="ptPhoneNumber" class="block text-sm font-medium text-gray-700"
						>Phone Number</label
					>
					<input
						id="ptPhoneNumber"
		...
		{#if selectedOption === 'large-project'}
			<div class="mt-6 space-y-4">
				<div>
					<label for="lpProjectDescription" class="block text-sm font-medium text-gray-700"
				...
				<div>
					<label for="lpTimelineStart" class="block text-sm font-medium text-gray-700"
				...
				<div>
					<label for="lpTimelineEnd" class="block text-sm font-medium text-gray-700"
				...
				<div>
					<label for="lpPocName" class="block text-sm font-medium text-gray-700"
						>Point of Contact Name</label
					>
					<input
						id="lpPocName"
				...
				<div>
					<label for="lpCompany" class="block text-sm font-medium text-gray-700"
						>Affiliated Company</label
					>
					<input
						id="lpCompany"
				...
				<div>
					<label for="lpPhoneNumber" class="block text-sm font-medium text-gray-700"
						>Phone Number</label
					>
					<input
						id="lpPhoneNumber"
		...
		{#if selectedOption === 'small-project'}
			<div class="mt-6 space-y-4">
				<div>
					<label for="spTaskDescription" class="block text-sm font-medium text-gray-700"
				...
				<div>
					<label for="spPocName" class="block text-sm font-medium text-gray-700"
						>Point of Contact Name</label
					>
					<input
						id="spPocName"
				...
				<div>
					<label for="spCompany" class="block text-sm font-medium text-gray-700"
						>Affiliated Company</label
					>
					<input
						id="spCompany"
				...
				<div>
					<label for="spPhoneNumber" class="block text-sm font-medium text-gray-700"
						>Phone Number</label
					>
					<input
						id="spPhoneNumber"
		...
		<div class="text-center">
			<button
				type="submit"
				class="rounded-full bg-green-600 px-8 py-4 text-lg font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-green-700 hover:shadow-lg disabled:bg-gray-400"
	...
	{#if message}
		<p class="mt-6 text-center font-semibold text-green-600">{message}</p>
	{/if}
</section>
